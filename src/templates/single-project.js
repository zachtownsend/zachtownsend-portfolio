...
import MagicContentReveal from '../components/MagicContentReveal';
...
ViewportBlockWrapper.propTypes = {
  inViewport: PropTypes.bool,
};

const ViewportBlock = handleViewport(ViewportBlockWrapper, { threshold: 1 });
